            ...
            <div key={index} className='py-4 border-t border-b text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4 '>
                <div className='flex items-start gap-6 text-sm'>
                  ...
                  <div>
                    ...
                    <p className='mt-1'>Ngày đặt: <span className='text-gray-700'>{new Date(item.date).toLocaleDateString('vi-VN')}</span></p>
                     <p className='mt-1'>Phương thức thanh Toán: <span className='text-gray-700'>{item.paymentMethod}</span></p>
                  </div>
                </div>
