  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Họ và tên' />
      ...
      <div className='mt-8'>
            ...
            <button onClick={()=>navigate('/order')} className='bg-black text-white px-16 py-3 text-sm'>Đặt hàng</button>
          </div>
          </div>
